      ...
      <form @submit.prevent="store" class="card-body">
        ...
        <div class="form-section">
          ...
          <div class="form-row">
            ...
            <div class="form-group flex-1"><label>Deal</label><Select v-model="form.deal_id" :options="deals" optionLabel="title" optionValue="id" placeholder="Chọn deal" showClear filter class="w-full" /></div>
          </div>
          <div class="form-row">
